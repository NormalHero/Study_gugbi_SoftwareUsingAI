...
*/
    ...
    public  String login(UserVO userVO){
        return "app/task01/" + (userVO.getId().equals("admin") ? "admin" : "user");
    }
...
/*
    ...
    if (request.getMethod().toLowerCase().equals("get")){
        return "/ex/app/task01/login";
    }else{
        log.info(userVO.getId());
        if(userVO.getId().equals("admin")){
            return "/ex/app/task01/admin";
        }else if(userVO.getId().equals("user")){
            return "/ex/app/task01/user";
        }else{
            return "/ex/app/task01/another";
        }
    }
