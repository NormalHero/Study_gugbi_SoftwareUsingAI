...
//    }
    ...
    public void testModify() throws Exception {
        String checkModify = mockMvc.perform(MockMvcRequestBuilders.post("/board/modify")
                .param("bno", String.valueOf(2L))
                .param("title", "(컨트롤러)수정된 테스트 제목")
                .param("content", "(컨트롤러)수정된 테스트 내용")
    ...
    public void testRemove() throws Exception {
        String checkRemove = mockMvc.perform(MockMvcRequestBuilders.get("/board/remove")
                .param("bno", String.valueOf(7L))).andReturn().getFlashMap().toString();
    ...
    public void testRead() throws Exception {
        ...
        String checkRead = mockMvc.perform(MockMvcRequestBuilders.get("/board/read")
                .param("bno", String.valueOf(9L))).andReturn().getModelAndView().getModelMap().toString();
        log.info(checkRead);
    }
