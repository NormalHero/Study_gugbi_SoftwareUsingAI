...
public class AskDAO {
	...
	//게시글 목록
		public List<AskVO> selectAll(Map<String, Integer> askMap) {
			return sqlSession.selectList("Ask.selectAll", askMap);
		}
		
		//게시글 전체 개수
		public int getTotal() {
			return sqlSession.selectOne("Ask.getTotal");
		}
		
		//게시글 정보 조회
		public AskVO selectDetail(int askNum) {
...
/*		//게시글 삭제
		public void delete(int askNum) {
			sqlSession.delete("Board.delete", askNum);
		}*/
