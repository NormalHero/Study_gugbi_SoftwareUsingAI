            ...
            <div id="main" class="container medium">
               ...
               <hr style = "margin-top:15px !important;">
					 ...
					 <form action="${pageContext.request.contextPath}/ask/AskInsertOk.ask" name="insertForm" method="post" enctype="multipart/form-data">
						<div>
							...
							<div class= "label">  
								...
								<select id = "category"  class = "input" style ="width:200px;" required>
							...
							<div class= "label">
								...
								<div>
									<input type = "text" id ="titleQ"  class = "input inputTitle" style ="width:79%; background: white;" required >
								</div>
							</div>
							<div class= "label" style = "height: 260px;">
								...
								<div>
									<textarea id ="titleQ" cols = "30" rows = "10" class = "inputTextarea" required></textarea>
								</div>
							</div>
					...
					<div class="bButton" style = "text-align: center;">
						<input class="uploadButton" type="submit" style = "" value="글쓰기"onclick="location.href='#'"><br>
					</div>
					<br>
					<br>
