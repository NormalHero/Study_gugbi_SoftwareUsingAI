                  ...
                  <li style="padding: 9px 1em;" class="special">
                     ...
                     <div id="menu">
                        ...
                        <li><a href="${pageContext.request.contextPath}/app/user/login.jsp">로그인</a></li>
                           <li><a href="${pageContext.request.contextPath}/app/myPage/myPage.jsp">마이페이지</a></li>
                            <li><a href="${pageContext.request.contextPath}/app/serviceSearch/searchJob.jsp">일자리 찾기</a></li>
                             <li><a href="${pageContext.request.contextPath}/app/serviceSearch/searchMom.jsp">시터 찾기</a></li>
                              <li><a onclick="location.href='${pageContext.request.contextPath}/community/CommunityListOk.com'">커뮤니티</a></li>
                           <li>
                              <span>고객센터</span>
                              <ul>
                                 <li><a href="${pageContext.request.contextPath}/app/notice/notice.jsp">공지사항</a></li>
