   ...
   <body class="is-preload" style="display:block; padding-top: 0; overflow-y: hidden">
      ...
      <!-- Main -->
         ...
         <div class="mainBox" style="padding-top: 3.5em;">
         	<a href="${pageContext.request.contextPath}/admin.jsp"><img src="${pageContext.request.contextPath}/images/로고2.png" style="width: 9%; position: absolute; margin: -50px 0px 0 26px;"></a>
