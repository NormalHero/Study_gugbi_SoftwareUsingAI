   ...
   <body class="is-preload" style="display:block; padding-top: 0; overflow-y: hidden">
      ...
      <!-- Main -->
         ...
         <div class="mainBox" style="padding-top: 3.5em;">
         	<a href="${pageContext.request.contextPath}/app/admin/admin.jsp"><img src="images/로고2.png" style="width: 9%; position: absolute; margin: -50px 0px 0 26px;"></a>
...
<table>
				<form method="post">
					...
					<tr style = "background-color: white;">
						<input type ="text" id="title" name = "title" placeholder="제목을 입력하세요" style = " resize: none; width: 100%;">
						...
						<td colspan="2" style = "padding:0;">
							...
							<input type="button" id="btn" value="완료"onclick="location.href='admin-inform.jsp'"><br>
						</div>
		<!-- Scripts -->
