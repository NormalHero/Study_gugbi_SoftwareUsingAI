            ...
            <div class = "noticeList">
                <div style = "position:relative;">
                    ...
                    <div style="text-align: center;">
                            <a href = "${pageContext.request.contextPath}/app/ask/askInsert.jsp"><button class = "new">새 문의</button></a>
                    </div>
           		 </div>
					<table>
						<tr class = "boardHead">
					...
					<c:forEach var="ask" items="${askList}">
						<tr class = "boarderInner">
                           ...
                           <td class = "category">
							...
							<td class = "title"><a href = "${pageContext.request.contextPath}/app/ask/askDetails.jsp?askNum=${ask.getAskNum()}&page=${page}" class = "titleTag">${ask.getAskTitle()}</a></td>
