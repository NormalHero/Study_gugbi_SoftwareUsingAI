                     ...
                     <c:choose>
						<c:when test="${communityList != null and fn:length(communityList) > 0}">
							...
							<c:forEach var="community" items="${communityList}">
							 <c:choose>
							<c:when test="${community.getCommunityCategory() eq 1}"> <article class="style1">
							<span class="image">
							...
							<c:when test="${community.getCommunityCategory() eq 2}"> <article class="style2">
							<span class="image">
                              		<img src="${pageContext.request.contextPath}/images/pic01.jpg" alt="" />
                           		</span>
                           			<a onclick="location.href ='${pageContext.request.contextPath}/community/CommunityDetailOk.com?communityNum=${community.getCommunityNum()}&page=${page}'">
							...
							<c:when test="${community.getCommunityCategory() eq 3}"> <article class="style3">
							<span class="image">
                              		<img src="${pageContext.request.contextPath}/images/pic01.jpg" alt="" />
                           		</span>
                           			<a onclick="location.href ='${pageContext.request.contextPath}/community/CommunityDetailOk.com?communityNum=${community.getCommunityNum()}&page=${page}'">
