...
<body>
  ...
  <div class="wrapper">
	...
	class="mediaModal1"
			>대체 내용</iframe>  
			  <a class="modal_close_btn" style="border:none;"><img src="images/whiteX.png" style="width:20px;"></a>
        </div>
            ...
            <hr style = "margin: 0px; width: 95%; padding: 10px 0;" >
                <div class = "innerContent" style = "position:relative;">
                    <p class ="innerTitle">희망 시급</p>             
                      <form class="range">
                            ...
                            <!--  여기서 희망시급 변환 !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! -->
                                <span></span>
                                <div style = "display:flex; justify-content: center; color:black; font-weight:bold;">
                              	  <input type = "number" style = "border:none; width:100px;" value=""> 원
                                </div>           
                            </div><!--/form-group-->
                     </form>
                </div>
                ...
                <div class = "innerContent" style = "position:relative;">
                  <p class ="innerTitle" style = "float:left; margin-right:20px;">인증서 업로드</p>   
                         ...
                         <div>
                          <span><img src = "images/questions.png" style = "width:25px;"></span>
    ...
    <aside class = "aside2">
        ...
        ">
            <div>
                ...
                <a href = "searchMomCopy.jsp;"><button class = "buttonAside">시터 게시글 목록</button></a>
            </div>
        </div>
        <br>
        <div style="
