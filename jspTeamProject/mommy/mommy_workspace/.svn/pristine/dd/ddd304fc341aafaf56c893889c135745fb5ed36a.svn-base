			...
			<div id="main" class="container">
				...
				<div id="mainbox" class="mainbox">
					<div class="font-position">
						...
						<div>
							<input type="text" class="input-font" style="width: 95%;"placeholder="이름을 입력해주세요">
						</div>
							<br>
						<div>
						...
						<div>
							<input type="text" class="input-font" style="width: 95%;" placeholder="생년월일 8자리를 입력해주세요 (예시 : 19860107)">
						</div>
							<br>
						<div>
						...
						<div>
							<input type="text" class="input-font" style="width: 95%;" placeholder="휴대폰번호를 입력해주세요 (예시 : 01012345678)">
						</div>
					</div>
				</div>
					<div>
