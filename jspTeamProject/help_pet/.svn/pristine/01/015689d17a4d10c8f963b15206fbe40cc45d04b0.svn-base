...
<!-- wrapForm -->
   ...
   <section>
      ...
      <li class="grid" >
      	<div class="wrap">
      		<div class="g_img" onclick="window.location.href = '${pageContext.request.contextPath}/app/jsp/board/boardPetSearchView.jsp';">
      ...
      <li class="grid" >
      	<div class="wrap">
      		<div class="g_img" onclick="window.location.href = '${pageContext.request.contextPath}/app/jsp/board/boardPetSearchView.jsp';">
      			<img src="http://www.animal.go.kr/files/shelter/2022/01/202202091402517.jpg" >
      			<div id="statusImg">
	           <img src="${pageContext.request.contextPath}/images/unCheck.png"> 
	            </div> 
      		</div>
      		<div>
      			<div class="text">
