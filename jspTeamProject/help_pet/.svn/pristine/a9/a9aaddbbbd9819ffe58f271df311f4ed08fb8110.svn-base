...
<%@ include file="/app/jsp/fix/join_header.jsp" %> 
                     ...
                     <div class="join_text"> 
                    <img src="https://cdn.discordapp.com/attachments/947836644889870356/949742835282870282/unknown.png" alt="" >
            </div>
                ...
                <div class="left_low">
                       ...
                       <a >이용약관</a> 
                        ...
                        <div class="join_foter_radio">
                        <input type="radio"  id= "checkAgree" name="checkradio1"  value="0"><label>동의함</label>
                        <input type="radio"   id= "checkDisAgree" name="checkradio1"  value="1"><label>동의안함</label>
                        </div>
                          </div>     

                        <div class="left_low_text">
                        <div class="left_low_text_box">
                        <textarea  id="low_area" cols="45" rows="30"  readonly="readonly" disabled>제1조(목적)
                                이 약관은 미니펫몰 회사(전자거래 사업자)가 운영하는 미니펫몰 사이버 몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.
                                ※ 「PC통신등을 이용하는 전자거래에 대해서도 그 성질에 반하지 않는한 이 약관을 준용합니다」
                                제2조(정의)
                                ① "몰"이란 미니펫몰 회사가 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화 또는 용역을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
                                ...
                                6. 결제방법의 선택 제10조 (계약의 성립) ① "몰"은 제9조와 같은 구매신청에 대하여 다음 각호에 해당하면 승낙하지 않을 수 있습니다. 다만, 미성년자와 계약을 체결하는 경우에는 법정대리인의 동의를 얻지 못하면 미성년자 본인 또는 법정대리인이 계약을 취소할 수 있다는 내용을 고지하여야 합니다.
                    ...
                    <div class=" right_row">
                        <div style="display: flex; align-items: center; justify-content: space-between;">
                            <a >이용약관</a> 
                             ...
                             <div class="join_foter_radio">
                             <input type="radio"  id= "checkAgree2" name="checkradio2"  value="0"><label>동의함</label>
                             <input type="radio" id= "checkDisAgree" name="checkradio2"  value="1"><label>동의안함</label>
                             </div>
                               </div>     
                            ...
                            <!-- 제출버튼 -->
                            <div class="join_btn">
                            <input   onclick="checkradio()" type="button" value="다음단계" id="join_btn">
                        </div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/assets/js/join1.js" ></script>
</html>