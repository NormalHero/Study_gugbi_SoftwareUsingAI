    ...
    <section>
        ...
        밤순이 배고팡!</pre></p> -->
       	<div class="write" style="margin-top: -25px;">
       		<h4 class="subject">우리 밤순이 좀 보세요!</h4>
       		<ul class="date">
       			<li style="margin-right: 660px;">작성자 : bamsoon1234</li>
       			<li style="visibility: hidden;">게시글 번호 : 26</li>
