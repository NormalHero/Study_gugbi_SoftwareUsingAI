		...
		<div id="wrapper">
			...
			<form action="#" name="findIdForm" id="findIdForm">
				<div class="id_find_wrap">
					...
					<div>
						<p id="input_warning" style="display: none;"></p>
					</div>
				<div>
				...
				<br>
				<div>
					<input type="button" id="findId" value="아이디 찾기 이메일 전송" onclick="checkId()">
				</div>
			</form>
			</div>
			<div id="contents">
			...
			<form action="#" name="findPwForm" id="findPwForm">
				...
				<br>
				<div>
					<input type="button" id="findPassword" value="비밀번호 찾기 이메일 전송" onclick="checkPw()">
				</div>
			</form>
			</div>
		</div>
