...
<%@ include file="/app/jsp/fix/join_header.jsp" %> 
    ...
    <div class="wapper_join">
        ...
        <form action="https://www.naver.com" method="post" name="join1form" id="join1form"  onsubmit="return checkjoin()">
            ...
            <div class="form_join">
                <ul class="form_join_ul">
                    ...
                    <li class="form_join_li">
                        <div class="inputbox _btn">
                            <input type="password" name="reuserpw" id="reuserpw" class="input_join" maxlength="20" placeholder="비밀번호확인" > 
                            <label class="inputbox_label">비밀번호 확인<em id="list4">(필수)</em></label>
						</div>
					</li>
                    <li class="form_join_li">
                        <div class="inputbox _btn">
                            <input type="text" name="usernick" id="usernick" class="input_join" maxlength="10" placeholder="닉네임" > 
                    ...
                    <li class="form_join_li">
                        <div class="inputbox _btn">
                            <input type="tel" name="userphone" id="userphone" class="input_join"  placeholder="하이픈(-)없이 입력해주세요" > 
                    ...
                    <li class="form_join_li">
                        <div class="inputbox _btn">
                            <input type="text" name="userpet" id="userpet" class="input_join"  placeholder="견종/묘종" > 
