        ...
        <div class="wrap_mid">
            ...
            <table class="info">
                ...
                <tr>
                    ...
                    <p id="emailCheck"></p>
                    <td class="col2">
                        <input type="text" name="input" class="input"><span>@</span>
                ...
                <tr>
                    ...
                    <p id="contentCheck"></p>
                    <td class="col2">
                        <textarea placeholder="1000자 이내로 입력하세요." name="userContent" id="userContent">
                            </textarea>
                    </td>
                </tr>
            </table>
            ...
            <div class="check_wrap">
                <p class="agree_check">
                    <input type="checkbox" class="input_check" id="check_privacy" value="Y">
                    <label for="check_privacy">개인정보 수집 및 이용에 동의합니다.
                        <span class="color_red">(필수)</span>
                    </label>
                </p>
                <div class="agree_info">
                    <textarea class="agree_privacy" name="agree_privacy" id="" cols="30" rows="10">
