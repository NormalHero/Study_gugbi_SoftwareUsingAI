...
create database JSPuser;
create database SpringUser;

drop database JSPuser;
drop database SpringUser;
...
values('park1234', '1234', 20, '2002-12-04');

delete from guest where userId='hds1234';

/*암호화*/
insert into guest(userId, userPw, userAge, birth)
values('park1234', hex(aes_encrypt('1234', 'abc')), 20, '2002-12-04');
...
values('park2222', hex(aes_encrypt('1234', 'abc')), 20);
...
values('박민수', '2000-12-04');
insert into `member`(memberName, memberBirth)
values('박민수', '2008-12-04');
insert into `member`(memberName, memberBirth)
values ('한동석','2001-12-10');
