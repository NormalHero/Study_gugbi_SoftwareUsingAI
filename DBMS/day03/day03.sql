...
CREATE TABLE PET(
	registNum NUMBER CONSTRAINT PT_PET PRIMARY KEY,
	petType VARCHAR2(1000),
	name VARCHAR2(1000),
	age NUMBER(3),
	reason VARCHAR2(3000),
...
VALUES(1, 'PARK1234', '박민수', '컴퓨터공학' , '1999-12-04');

INSERT INTO TBL_STUDENT
(NUM, ID, NAME, MAJOR,GENDER , BIRTH)
VALUES(2, 'hong1234', '홍길동', '컴퓨터공학','M' , TO_DATE('1980-01-01','YYYY-MM-DD'));

INSERT INTO TBL_STUDENT
VALUES(3, 'hong1234', '홍길동', '컴퓨터공학','M' , TO_DATE('1980-01-01','YYYY-MM-DD'));
...
UPDATE TBL_STUDENT WHERE 

TRUNCATE TABLE TBL_STUDENT; -- 복구가 되지않음 DDL
...
SELECT  NUM FROM TBL_STUDENT ts 
...
-- PLAYER 테이블에서 TEAML_ID가 'K01'인 선수 이름을 내 이름으로 바꾸기
UPDATE PLAYER
SET PLAYER_NAME = '박민수'
WHERE TEAM_ID = 'K01';
...
-- PLAYER 테이블에서 HEIGHT 180이상인 선수 삭제하기 
