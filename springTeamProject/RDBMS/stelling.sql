...
CREATE TABLE TBL_USER(
	...
	USER_STATUS NUMBER,  /* -- 0 탈퇴 1 일반 2 관리자*/
	USER_COINBALANCE NUMBER DEFAULT (0), /*코인 잔액*/
...
CREATE TABLE TBL_NOVEL(
    ...
    NOVEL_MONDAY NUMBER DEFAULT (0),
    NOVEL_TUESDAY NUMBER DEFAULT (0),
    NOVEL_WEDNESDAY NUMBER DEFAULT (0),
    NOVEL_THURSDAY NUMBER DEFAULT (0),
    NOVEL_FRIDAY NUMBER DEFAULT (0),
    NOVEL_SATURDAY NUMBER DEFAULT (0),
    NOVEL_SUNDAY NUMBER DEFAULT (0),
    ...
    NOVEL_FILENAME VARCHAR2(1000),
    NOVEL_UPLOADPATH VARCHAR2(1000),
    NOVEL_UUID VARCHAR2(1000),
...
CREATE TABLE TBL_SUBNOVEL(
	...
	SUBNOVEL_VIEWCOUNT NUMBER DEFAULT 0, /*조회수*/
	SUBNOVEL_LIKECOUNT NUMBER DEFAULT 0, /*좋아요 수*/
...
CREATE TABLE TBL_PAY(
	...
	PAY_STATUS NUMBER DEFAULT 0, /* 환불 및 기타 상태 */
...
CREATE TABLE TBL_MYPICK(
	...
	MYPICK_PICK NUMBER DEFAULT 0, /*찜이면 1 아니면 0 ?*/ 
	NOVEL_NUMBER NUMBER, /*FK*/
	USER_NUMBER NUMBER, /*FK*/
...
CREATE TABLE TBL_ILLUSTIMGFILE(
	...
	ILLUSTIMGFILE_UUID VARCHAR2(1000),
...
CREATE TABLE TBL_PROFILEIMGFILE(
	...
	PROFILEIMGFILE_UUID VARCHAR2(1000),
