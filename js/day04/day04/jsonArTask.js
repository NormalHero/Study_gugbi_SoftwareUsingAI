...
// 총 가격과 재고를 Object에 담은 뒤 sum.json으로 출력한다.
...
// shop = new Array();
// var book = {name : '동물원에서살아남기', price : 8900, stock : 10};
// var note = {name : '무제1000노트', price : 1000, stock : 52};
// var pen = {name : '볼펜', price : 700, stock : 15};
...
// file.writeFile("day04/shop2.json",shopJSON,function(e){
//     if(e){
//         console.log(e);
//     }else{
//         console.log("출력 성공!");
...
// file.readFile("day04/shop2.json","UTF-8",function(e,datas){
//      shopAr = JSON.parse(datas);
//      var sumData = new Array();

   
//      for (let i in shopAr) {
//         let  totalPrice = shopAr[i].price * shopAr[i].stock;
      
//         sumData[i] = {AllPrice: totalPrice, AllStock: shopAr[i].stock};
//         sumData.push(sumData[i]);
//      } 


//      var sumJSON = JSON.stringify(sumData);

//      file.writeFile("day04/sum2.json",sumJSON,function(e){
//         if(e){
//             console.log(e);
//         }else{
//             console.log("출력 성공!");
